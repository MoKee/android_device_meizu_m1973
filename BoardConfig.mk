...
# Fingerprint
SOONG_CONFIG_MEIZU_MSMNILE_FOD_POS_X := 445
SOONG_CONFIG_MEIZU_MSMNILE_FOD_POS_Y := 1806
SOONG_CONFIG_MEIZU_MSMNILE_FOD_SIZE := 190
SOONG_CONFIG_MEIZU_MSMNILE_FOD_INPUT := event6

# Light
SOONG_CONFIG_MEIZU_MSMNILE_LIGHT_MX_LED_PATH := /sys/class/leds/breath
